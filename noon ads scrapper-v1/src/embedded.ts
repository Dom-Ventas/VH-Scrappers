...
/** Default endpoints for the noon ads scraper, relative to the API root. */
export const QUERY_ENDPOINT = '/api/v1/scrapper/noon/queries';
export const RESULTS_ENDPOINT = '/api/v1/scrapper/noon/results';
