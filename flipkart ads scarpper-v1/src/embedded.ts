...
/** Default endpoints for the Flipkart ads scraper, relative to the API root. */
export const QUERY_ENDPOINT = '/api/v1/scrapper/flipkart/queries';
export const RESULTS_ENDPOINT = '/api/v1/scrapper/flipkart/results';
