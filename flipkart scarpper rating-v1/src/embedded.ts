...
/** Default endpoints for the Flipkart review scraper, relative to the API root. */
export const QUERY_ENDPOINT = '/api/v1/scrapper/flipkart/review-queries';
export const RESULTS_ENDPOINT = '/api/v1/scrapper/flipkart/reviews';
