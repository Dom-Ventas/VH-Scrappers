...
/** Default endpoints for the noon review scraper, relative to the API root. */
export const QUERY_ENDPOINT = '/api/v1/scrapper/noon/review-queries';
export const RESULTS_ENDPOINT = '/api/v1/scrapper/noon/reviews';
