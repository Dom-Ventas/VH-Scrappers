...
/** Default endpoints for the Amazon review scraper, relative to the API root. */
export const QUERY_ENDPOINT = '/api/v1/scrapper/review-queries';
export const RESULTS_ENDPOINT = '/api/v1/scrapper/reviews';
